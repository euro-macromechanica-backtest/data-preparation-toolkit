...
- **Metric‑computation methodology and metric calculators** for EMM backtest results — *[metrics-toolkit](https://github.com/euro-macromechanica-backtest/metrics-toolkit)*
