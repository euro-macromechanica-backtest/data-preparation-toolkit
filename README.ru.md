...
- **Схема методологии расчёта метрик и калькуляторы метрик** для результатов бэктеста EMM — *[metrics-toolkit](https://github.com/euro-macromechanica-backtest/metrics-toolkit)*
